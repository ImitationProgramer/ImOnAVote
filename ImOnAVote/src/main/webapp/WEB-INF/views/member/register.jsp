            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">ImOnAVote</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">너의 생각을 보여줘 🚀</h4>
              <p class="mb-4">사람들과 생각을 공유해보세요!</p>

              <form id="register" class="mb-3" action="/member/register" onsubmit="return checkFormValidation();" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <label for="birthAt" class="form-label">생년월일</label>
                  <input type="text" class="form-control" name="birthAt" placeholder="yyyy-MM-dd" />
                </div>
                <div class="mb-3">
                  <label for="hp" class="form-label">핸드폰 번호</label>
                  <input type="text" class="form-control" id="hp" name="hp" placeholder="010-0000-0000" required>
                  <input type="checkbox" id="smsstsYn" name="smsstsYn" value="y" checked/>
                  이벤트나 새로운 소식에 관한 SMS 수신에 동의합니다.
                </div>
    ...
    <script>
    	...
    	$().ready(function(){
    		$("#isValidId").click(function(){
    			...
    			$("#isValidNm").click(function(){
    				
    				let memberNm = $("#memberNm").val();
    				let birthAt = $("#birthAt").val();
    				let hp = $("#hp").val();
    				
    				if(memberNm = ''){
    					$("#isValidNmMsg").html("<span style='color:red;'>이름을 입력하세요.</span>")
    					$("#memberNm").focus();
    					return false;
    				}
    				if(birthAt = ''){
    					$("#isValidNmMsg").html("<span style='color:red;'>생년월일을 입력하세요.</span>")
    					$("#birthAt").focus();
    					return false;
    				}
    				if(hp = ''){
    					$("#isValidNmMsg").html("<span style='color:red;'>핸드폰 번호를 입력하세요.</span>")
    					$("#hp").focus();
    					return false;
    				}
    				...
    				$.ajax({
    					...
    					data : {"memberNm" : memberNm,
    						    "birthAt" : birthAt,
    						    "hp" : hp},
    					success : function(isValidNm){
    						if (isValidNm == "y") {
    				          	$("#isValidNmMsg").html("<span style='color:green;'>사용가능한 명의입니다.</span>");
    				          	isPassNm = true;
    				          }
    				          else {
    			        		$("#isValidNmMsg").html("<span style='color:red;'>사용중인 명의입니다.</span>");
    			        		isPassNm = false;
    				          }
    					}
    				})
