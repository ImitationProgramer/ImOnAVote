        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper" >
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">${surveyDTO.writer }님의 설문입니다.</h4>
                ...
                <div class="col-xl-6">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3 row">
                        <label for="html5-search-input" class="col-md-2 col-form-label">답:</label>
                        <div class="col-md-10">
                          <input type="radio" name="payYn" value="y">네 &emsp;&emsp;&emsp;
